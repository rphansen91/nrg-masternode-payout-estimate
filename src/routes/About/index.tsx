  ...
  return (
    <MainLayout>
      <Container maxWidth="sm">
        ...
        <Typography paragraph>The estimation algorithm is public and can be found on <Link href="https://github.com/rphansen91/nrg-masternode-payout-estimate/blob/master/src/providers/Energi/estimate.tsx">GitHub</Link></Typography>
